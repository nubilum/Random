...
XS(XS_Random_choice); /* prototype to pass -Wmissing-prototypes */
XS(XS_Random_choice)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
extern "C"
#endif
XS(boot_Random); /* prototype to pass -Wmissing-prototypes */
XS(boot_Random)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXSproto_portable("Random::choice", XS_Random_choice, file, "$@");
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
