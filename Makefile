# This Makefile is for the Random extension to perl.
#
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /Users/nubilum/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /Users/nubilum/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.64
MM_REVISION = 66400
...
TO_INST_PM = lib/Random.pm

PM_TO_BLIB = lib/Random.pm \
	blib/lib/Random.pm
...
# Random might depend on some other libraries:
...
.c.i:
	llvm-gcc-4.2 -E -c $(PASTHRU_INC) $(INC) \
	$(CCFLAGS) $(OPTIMIZE) \
	$(PERLTYPE) $(MPOLLUTE) $(DEFINE_VERSION) \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Random.pm $(INST_MAN3DIR)/Random.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''nubilum'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Random' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "nubilum"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Random",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>nubilum</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Random.pm blib/lib/Random.pm 
